...
@Service
@Transactional
public class JiraIssuePushService {
     ...
     *
     * @param issue Issue từ SRPM (có issueCode = null)
     * @param jiraUrl URL Jira
     * @param projectKey Project Key trong Jira
     * @param jiraAdminEmail Email admin Jira
     * @param jiraApiToken API Token Jira
     * @return Issue đã được cập nhật issueCode từ Jira
     * @throws RuntimeException nếu gọi Jira API thất bại
     */
     ...
     *
     * @param issue Issue từ SRPM (phải có issueCode)
     * @param jiraUrl URL Jira
     * @param jiraAdminEmail Email admin Jira
     * @param jiraApiToken API Token Jira
     * @return Issue sau khi cập nhật
     * @throws RuntimeException nếu gọi Jira API thất bại
     */
     ...
     *
     * @param issueCode Mã Issue trên Jira (ví dụ: PROJECT-123)
     * @param targetStatusName Tên status target (ví dụ: "Done", "In Progress")
     * @param jiraUrl URL Jira
     * @param jiraAdminEmail Email admin Jira
     * @param jiraApiToken API Token Jira
     */
