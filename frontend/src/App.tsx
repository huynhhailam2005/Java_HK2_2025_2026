...
function App() {
    ...
    return (
        <BrowserRouter>
            {/* 🔥 GLOBAL LIQUID GLASS TOAST - SỐNG XUYÊN TRANG 🔥 */}
            <AnimatePresence>
                {toastInfo && (
                    <motion.div
                        ...
                        // 🛠️ Đổi z-[9999] thành z-9999 (Tailwind v4 chuẩn)
